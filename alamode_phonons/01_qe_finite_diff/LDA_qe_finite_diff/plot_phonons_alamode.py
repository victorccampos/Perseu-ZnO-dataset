...
if __name__ == "__main__":
    ...
    # Experimental
    EXPDATA_DIR = "/home/jvc/ZnO_database/Phonons/phonon-experimental-data_THz"
    path_to_exp = [
    ...
    fig.suptitle("LDA - QE + ALAMODE", fontsize=14, fontfamily="serif")
    ...
    plt.savefig("zno_phband_alamode_NA3.pdf", bbox_inches="tight")
    plt.tight_layout()
    plt.show()
